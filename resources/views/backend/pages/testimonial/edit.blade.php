                ...
                <div class="card-body">
                    <form action="{{ route('testimonial.update', $testimonial->client_name_slug) }}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input value="{{ $testimonial->client_name }}" type="text"
                                class="form-control @error('client_name')
                                is-invalid
                            @enderror"
                                name="client_name" id="client_name" placeholder="Enter a Client Name">
                            @error('client_name')
                        ...
                        <div class="mb-3">
                            <label for="client_image" class="form-label">Slider Image</label>
                            <input type="file" name="client_image" id="client_image" class="dropify"
                                data-default-file="{{ asset('uploads/testimonial' . '/' . $testimonial->client_image) }}" />
                            @error('client_image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            <input type="checkbox" name="is_active"
                                ...
                                is-invalid
                            @enderror"
                                role="switch" id="is_active" @if ($testimonial->is_active) checked @endif>
